...
export class Client {
  ...
  async addDeviceInterest(interest) {
    ...
    validateInterestName(interest);                                                       //  validate (1)  
  ...
  async removeDeviceInterest(interest) {
    ...
    validateInterestName(interest);                                                           //  validate (2)  
  ...
  async setDeviceInterests(interests) {
    ...
    for (let interest of interests) {
      validateInterestName(interest);                                                                    //  validate (3)  
    }
...
const validateInterestName = interest => {                                                               //  validate (4)  
