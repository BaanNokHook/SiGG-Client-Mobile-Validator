...
(function (root) {
          ...
          self.batch = function (requests) {
              ...
              forEach(requests, function (req) {
                  if (req.hasOwnProperty('call')) {
                      let _call = call(req.call.method, req.call.params);
      ...
      /**
       * Static method for server_jsonrpc for creating a server_jsonrpc() instance pre-configured
       * for use in a browser, with JSON-RPC over HTTP using standard XHR.
       * 
       * Example:
       *     
       *     let rpc = server_jsonrpc.connect_xhr("http://rpc.example.com:8888");
       *     rpc.call("get_account", ["client"]).then(function(res) { 
       *         console.log("client full name:", res.full_name)
       *     })
       * 
       */
       client_jsonrpc.connect_xhr = function(rpc_url, rpc_config) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('client_jsonrpc', [], function () {
            return client_jsonrpc;
        });
    }
    else if (typeof module !== "undefined" && typeof module.exports !== "undefined") {
        module.exports = client_jsonrpc;
    }
    else if (typeof root !== "undefined") {
        root.client_jsonrpc = client_jsonrpc;
    }
    else {
        return client_jsonrpc;
    }
